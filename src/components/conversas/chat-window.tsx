    ...
    <div className="flex-1 flex flex-col h-full">
      ...
      <div className="bg-[#F0F2F5] px-4 py-3 border-b border-gray-200 flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          <p className="text-sm font-semibold text-gray-900 truncate">{conversation.leadName}</p>
      ...
      >
        {conversation.messages.length === 0 ? (
          <div className="flex items-center justify-center h-full">
            <p className="text-xs text-gray-400 bg-white/60 px-3 py-1.5 rounded-full shadow-sm">
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <p className="text-[10px] text-gray-400 text-right mt-1 select-none">
                    {msg.timestamp}
                  </p>
                </div>
              </div>
      ...
      {/* Input */}
      <div className="bg-[#F0F2F5] px-3 py-3 border-t border-gray-200 flex items-end gap-2">
        <div className="flex-1 bg-white rounded-2xl shadow-sm border border-gray-200 px-4 py-2">
          <textarea
            ref={textareaRef}
            value={input}
      ...
      <p className="text-[10px] text-gray-400 text-center pb-1.5 bg-[#F0F2F5] select-none">
